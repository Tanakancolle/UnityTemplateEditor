...
|Script Name|生成するファイルの名前を指定できます。拡張子も必要です。**{<>}** で囲むことで、置き換え文字にできます|
|Code|生成するファイルの内容を記述できます。**{<>}** で囲むことで、置き換え文字にできます|
|Replace Texts|**{<>}** で囲まれた文字を置き換える文字を指定できます。{<>}が出現すると自動でフォームが表示されます|
